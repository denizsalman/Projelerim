...
public class ClockPane extends Pane {
    ...
    private void paintClock() {
        getChildren().clear();
//        ImageView imageView = new ImageView("file:musti.jpg");
...
//        getChildren().add(imageView);
        ...
        lineHour.setVisible(hourHandVisible);
        ...
        lineMinute.setVisible(minuteHandVisible);
        ...
        lineSecond.setVisible(secondHandVisible);
